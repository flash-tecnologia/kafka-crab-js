...
function requireNative() {
  if (process.env.NAPI_RS_NATIVE_LIBRARY_PATH) {
    ...
    if (process.arch === 'arm64') {
      try {
        return require('./kafka-crab-js.android-arm64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        ...
        if (bindingPackageVersion !== '2.1.0-alpha.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 2.1.0-alpha.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
      } catch (e) {
        loadErrors.push(e)
    ...
    if (process.arch === 'x64') {
      if (process.config?.variables?.shlib_suffix === 'dll.a' || process.config?.variables?.node_target_type === 'shared_library') {
        try {
        return require('./kafka-crab-js.win32-x64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
        const binding = require('kafka-crab-js-win32-x64-gnu')
        const bindingPackageVersion = require('kafka-crab-js-win32-x64-gnu/package.json').version
        if (bindingPackageVersion !== '2.1.0-alpha.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
          throw new Error(`Native binding package version mismatch, expected 2.1.0-alpha.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
        }
        return binding
        ...
        try {
        return require('./kafka-crab-js.win32-x64-msvc.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./kafka-crab-js.darwin-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      try {
        return require('./kafka-crab-js.freebsd-x64.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
    ...
    if (process.arch === 'x64') {
      ...
      if (isMusl()) {
        try {
          return require('./kafka-crab-js.linux-loong64-musl.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('kafka-crab-js-linux-loong64-musl')
          const bindingPackageVersion = require('kafka-crab-js-linux-loong64-musl/package.json').version
          if (bindingPackageVersion !== '2.1.0-alpha.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 2.1.0-alpha.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
        ...
        try {
          return require('./kafka-crab-js.linux-loong64-gnu.node')
        } catch (e) {
          loadErrors.push(e)
        }
        try {
          const binding = require('kafka-crab-js-linux-loong64-gnu')
          const bindingPackageVersion = require('kafka-crab-js-linux-loong64-gnu/package.json').version
          if (bindingPackageVersion !== '2.1.0-alpha.2' && process.env.NAPI_RS_ENFORCE_VERSION_CHECK && process.env.NAPI_RS_ENFORCE_VERSION_CHECK !== '0') {
            throw new Error(`Native binding package version mismatch, expected 2.1.0-alpha.2 but got ${bindingPackageVersion}. You can reinstall dependencies to fix this issue.`)
          }
          return binding
      ...
      try {
        return require('./kafka-crab-js.linux-ppc64-gnu.node')
      } catch (e) {
        loadErrors.push(e)
      }
      try {
...
if (!nativeBinding || process.env.NAPI_RS_FORCE_WASI) {
  ...
  try {
    wasiBinding = require('./kafka-crab-js.wasi.cjs')
  ...
  if (!nativeBinding) {
    try {
      wasiBinding = require('kafka-crab-js-wasm32-wasi')
      nativeBinding = wasiBinding
    } catch (err) {
      if (process.env.NAPI_RS_FORCE_WASI) {
...
module.exports.KafkaClientConfig = nativeBinding.KafkaClientConfig
module.exports.KafkaConsumer = nativeBinding.KafkaConsumer
module.exports.KafkaProducer = nativeBinding.KafkaProducer
module.exports.CommitMode = nativeBinding.CommitMode
module.exports.KafkaEventName = nativeBinding.KafkaEventName
module.exports.PartitionPosition = nativeBinding.PartitionPosition
module.exports.SecurityProtocol = nativeBinding.SecurityProtocol
